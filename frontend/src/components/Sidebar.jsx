        ...
        >
            ...
            <div className='w-full h-[300px] bg-[#20c7ff] rounded-b-[30%] shadow-gray-400 shadow-lg flex flex-col justify-center px-[20px]'>
                ...
                <div className='w-full flex items-center gap-[20px] overflow-x-auto py-[18px]'>
                    ...
                    {!search && (
                        <div
                            className='w-[60px] h-[60px] flex-shrink-0 mt-[10px] rounded-full overflow-hidden flex justify-center items-center bg-white shadow-gray-500 shadow-lg cursor-pointer'
                    ...
                    {/* ALL USERS BESIDE SEARCH */}
                    {!search && otherUsers?.map((user) => (

                        <div
                            key={user._id}
                            className='relative flex-shrink-0 rounded-full shadow-gray-500 bg-white shadow-lg flex justify-center items-center mt-[10px] cursor-pointer'
